...
class PbjtRepository extends ClientDataService
{
    use Simpatda;

    public const ID_JENIS_OBJEK = [JenisPajak::RESTORAN, JenisPajak::HOTEL, JenisPajak::HIBURAN, JenisPajak::PPJ, JenisPajak::PARKIR];
